...
import { mockStats, mockUsageData, mockEndpointUsage, mockRecentRequests } from "@/lib/mock-data";
...
const kpiCards = [
    {
        ...
        value: mockStats.totalRequests.toLocaleString("tr-TR"),
        icon: BarChart3,
        change: "+12.5%",
    ...
    {
        label: "Kalan Kota",
        value: mockStats.remainingQuota.toLocaleString("tr-TR"),
        icon: Clock,
        change: "50K günlük",
    ...
    {
        label: "Aktif API Key",
        value: mockStats.activeKeys.toString(),
        icon: Key,
        change: "3 aktif",
                            ...
                            {mockRecentRequests.map((req) => (
                                ...
                                >
                                    ...
                                    <td className="py-3 pr-4">
                                        <Badge
                                            variant="outline"
                                            className={`font-mono text-xs ${req.status === 200
